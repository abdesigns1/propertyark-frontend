      ...
      <div className="relative flex min-w-0 flex-col px-5 py-5 md:px-6">
        ...
        <div className="pr-12">
          <Link
            ...
            className="line-clamp-1 text-lg font-semibold text-primary hover:text-primary-hover"
          >
            {property.title}
          </Link>
          ...
          <div className="mt-4 flex flex-wrap items-center gap-4 text-sm text-muted-foreground">
            ...
            {property.sizeSqm && (
              <span className="flex items-center gap-1.5">
                ...
                {property.sizeSqm.toLocaleString()} {property.sizeUnit ?? "sqm"}
              </span>
            )}
          </div>
        </div>
        ...
        <div className="flex flex-wrap items-center justify-between gap-3">
          ...
          <div className="flex gap-2">
            ...
            <Button asChild>
              <Link href={`/properties/${property.id}`}>Book Inspection</Link>
            </Button>
          </div>
        </div>
      </div>
